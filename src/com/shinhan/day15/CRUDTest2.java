...
public class CRUDTest2 {
	...
	public static void main(String[] args) throws SQLException {
		...
		Statement st2 = null;
		String sql1 = """
				insert into emp1(employee_id, first_name, last_name, hire_date, 
				job_id,email) values (4,'aa','bb',sysdate, 'IT','zzilre')
				""";
		String sql2 = """
	...
	public static void f_4() throws SQLException {
		...
		result = st.executeUpdate(sql);  //자동 commit
	...
	public static void f_2() throws SQLException {
		...
		int result = 0;
		String sql = """
			insert into emp1 values(4,'김','세연','zzilre@naver','폰',sysdate,'job',100,0.2,100,'20')
				""";
